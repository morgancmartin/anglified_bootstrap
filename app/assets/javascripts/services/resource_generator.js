...
['Restangular', '_', 'pluralize', function(Restangular, _, pluralize) {
  ...
  function _getFactoryConfig (resource) {
  ...
  srv.generate = function (resource, moduleVar) {
